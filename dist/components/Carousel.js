...
exports.Carousel = (0, react_1.forwardRef)(function (props, ref) {
    ...
    var next = function (event) {
        ...
        var nextActive = state.active + 1 > last
            ? cycleNavigation
                ? 0
                : state.active
            : state.active + 1;
    ...
    var prev = function (event) {
        var children = sanitizedProps.children, cycleNavigation = sanitizedProps.cycleNavigation;
        var last = Array.isArray(children) ? children.length - 1 : 0;
        var nextActive = state.active - 1 < 0
            ? cycleNavigation
                ? last
                : state.active
            : state.active - 1;
    ...
    return ((0, jsx_runtime_1.jsxs)(Styled_1.StyledRoot, __assign({ sx: sx, className: className, onMouseOver: function () {
            ...
            stopAutoPlayOnHover && setPaused(false);
        } }, { children: [(0, jsx_runtime_1.jsx)(Styled_1.StyledItemWrapper, __assign({ style: { height: height ? height : childrenHeight } }, { children: Array.isArray(children) ? (children.map(function (child, index) {
                    return ((0, jsx_runtime_1.jsx)(CarouselItem_1.CarouselItem, { state: state, index: index, maxIndex: children.length - 1, child: child, animation: animation, duration: duration, swipe: swipe, next: next, prev: prev, height: height, setHeight: setChildrenHeight }, "carousel-item" + index));
                })) : ((0, jsx_runtime_1.jsx)(CarouselItem_1.CarouselItem, { state: state, index: 0, maxIndex: 0, child: children, animation: animation, duration: duration, height: height, setHeight: setChildrenHeight }, "carousel-item0")) }), void 0), !navButtonsAlwaysInvisible && showButton(true) && ((0, jsx_runtime_1.jsx)(Styled_1.StyledButtonWrapper, __assign({ "$next": true, "$prev": false, "$fullHeightHover": fullHeightHover }, navButtonsWrapperProps, { children: NavButton !== undefined ? (NavButton(__assign({ onClick: next, next: true, prev: false }, navButtonsProps))) : ((0, jsx_runtime_1.jsx)(Styled_1.StyledIconButton, __assign({ "$alwaysVisible": navButtonsAlwaysVisible, "$fullHeightHover": fullHeightHover, onClick: next, "aria-label": "Next" }, navButtonsProps, { children: NextIcon }), void 0)) }), void 0)), !navButtonsAlwaysInvisible && showButton(false) && ((0, jsx_runtime_1.jsx)(Styled_1.StyledButtonWrapper, __assign({ "$next": false, "$prev": true, "$fullHeightHover": fullHeightHover }, navButtonsWrapperProps, { children: NavButton !== undefined ? (NavButton(__assign({ onClick: prev, next: false, prev: true }, navButtonsProps))) : ((0, jsx_runtime_1.jsx)(Styled_1.StyledIconButton, __assign({ "$alwaysVisible": navButtonsAlwaysVisible, "$fullHeightHover": fullHeightHover, onClick: prev, "aria-label": "Previous" }, navButtonsProps, { children: PrevIcon }), void 0)) }), void 0)), indicators ? ((0, jsx_runtime_1.jsx)(Indicators_1.Indicators, { length: Array.isArray(children) ? children.length : 0, active: state.active, press: setNext, indicatorContainerProps: indicatorContainerProps, indicatorIconButtonProps: indicatorIconButtonProps, activeIndicatorIconButtonProps: activeIndicatorIconButtonProps, IndicatorIcon: IndicatorIcon }, void 0)) : null] }), void 0));
});
